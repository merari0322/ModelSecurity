...
namespace Data
{
    public class ExperiencePopulationData
    {
        ...
        private readonly ILogger<ExperiencePopulationData> _logger;
        ...
        public ExperiencePopulationData(ApplicationDbContext context, ILogger<ExperiencePopulationData> logger)
        {
            _context = context;
            _logger = logger;
        }
