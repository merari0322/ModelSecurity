...
namespace Data
{
    public class EvaluationCriteriaData
    {
        ...
        private readonly ILogger<EvaluationCriteriaData> _logger;
        ...
        public EvaluationCriteriaData(ApplicationDbContext context, ILogger<EvaluationCriteriaData> logger)
        {
            _context = context;
            _logger = logger;
        }
